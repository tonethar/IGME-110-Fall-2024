...
- [Github](https://en.wikipedia.org/wiki/GitHub) is frequently used in your college courses to host software projects and related code, as well as other files and documents. It uses [Git](https://en.wikipedia.org/wiki/Git) which provides distributed version control.
